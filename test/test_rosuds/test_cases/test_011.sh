...
LISTENERPID1=$!
ROS_UDS_EXT_ENABLE=on ${CPP_LISTENER} __name:=no2 >/dev/null 2>&1  &
LISTENERPID2=$!
ROS_UDS_EXT_ENABLE=on ${CPP_LISTENER} __name:=no3 >/dev/null 2>&1  &
LISTENERPID3=$!
ROS_UDS_EXT_ENABLE=on ${CPP_LISTENER} __name:=no4 >/dev/null 2>&1  &
LISTENERPID4=$!
ROS_UDS_EXT_ENABLE=on ${CPP_LISTENER} __name:=no5 >/dev/null 2>&1  &
LISTENERPID5=$!
ROS_UDS_EXT_ENABLE=on ${CPP_LISTENER} __name:=no6 >/dev/null 2>&1  &
LISTENERPID6=$!
ROS_UDS_EXT_ENABLE=on ${CPP_LISTENER} __name:=no7 >/dev/null 2>&1  &
LISTENERPID7=$!
ROS_UDS_EXT_ENABLE=on ${CPP_LISTENER} __name:=no8 >/dev/null 2>&1  &
LISTENERPID8=$!
ROS_UDS_EXT_ENABLE=on ${CPP_LISTENER} __name:=no9 >/dev/null 2>&1  &
LISTENERPID9=$!
ROS_UDS_EXT_ENABLE=on ${CPP_LISTENER} __name:=no10 >/dev/null 2>&1  &
LISTENERPID10=$!
sleep $((SLEEP_TIME*3))
