...
public:
  RandomAccessBagTestClass() {
    testBag.open("test.bag", rosbag::BagMode::Read);
    numberView = new rosbag::RandomAccessBag(testBag, "numbers");
    stringView = new rosbag::RandomAccessBag(testBag, "text");
  }
...
private:
  rosbag::Bag testBag;
  rosbag::RandomAccessBag *numberView, *stringView;
};
